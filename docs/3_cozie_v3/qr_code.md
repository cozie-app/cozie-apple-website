...
# Print deep link
print(deep_link_url)
print("Number of characters:", len(deep_link_url), "of 2048 characters (",int(len(deep_link_url)/2048*100) ,"%)")
